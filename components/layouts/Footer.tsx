			...
			<footer className='bg-gray-800 text-white py-10'>
				<div className='container mx-auto m-4 flex flex-nowrap flex-row items-center'>
					<ul className='flex items-center'>
						<li>
							<Link className='p-4  mr-6 text-xl' href='#'>
								Home
							</Link>
						</li>
						<li>
					...
					<div className='m-auto'>
						<h1 className=' p-4 text-white-500 mx-auto text-2xl'>
							Location:
						</h1>
						<h4>
							<iframe
					...
					<div className='m-auto'>
						...
						<h2 className=' p-4 text-white-500 mx-auto text-2xl'>
							Kanaga Velraj
						</h2>
						<Link
							href={`tel:${+918637459289}`}
							className=' p-4 text-white-500 mx-auto text-2xl'
						>
							+91 8637459289
						</Link>
					</div>
