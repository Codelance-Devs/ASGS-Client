...
export default function about() {
  return (
    <>
      ...
      {/* second banner  */}
      <section className="body-font bg-primaryBg text-gray-600">
        <div className="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
          ...
          <div className="flex flex-col items-center text-center md:w-1/2 md:items-start md:pl-16 md:text-left lg:flex-grow lg:pl-24">
            <h1 className="title-font mb-4 text-left font-primaryFont  text-4xl font-medium text-primaryText sm:text-5xl">
              Our mission is to help people save time while enjoying authentic
              home-cooking food with the most beneficial options
              <br className="hidden lg:inline-block" />
            </h1>
